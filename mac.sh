...
echo "Installing Go..."
wget https://go.dev/dl/go1.20.11.darwin-amd64.tar.gz || { echo "Failed to download Go! Exiting..."; exit 1; }
sudo tar -C /usr/local -xzf go1.20.11.darwin-amd64.tar.gz || { echo "Failed to extract Go! Exiting..."; exit 1; }
